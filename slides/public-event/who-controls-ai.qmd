...
## The Digital Silk Road Now Carries Models {.china-models}
...
<div class="dsr-models">DEEPSEEK · QWEN · GLM</div>
:::

::::

<div class="dsr-takeaway">China first exported the pipes. Now it exports the intelligence.</div>

<div class="dsr-source">Source: Hugging Face, <em>State of Open Source</em>, Spring 2026. Downloads are not unique users.</div>
...
::: {.dep-takeaway}
Each side controls something the other needs. But frontier capabilities are harder to replace. Dependence on frontier capabilities for economic growth and national security currently **shifts the balance toward firms.**
:::
