...
## {#november-2023 .photo-title .opening-headline .no-visible-title background-image="../../assets/pe_bletchley_summit.png" background-size="auto 80%" background-color="#041e42" background-position="center"}

::: {.photo-caption .opening-caption}
<div class="opening-caption-date">NOVEMBER 2023</div>
...
## {#february-2025 .photo-title .opening-headline .no-visible-title background-image="../../assets/pe_paris_summit.png" background-size="auto 80%" background-color="#041e42" background-position="center"}

::: {.photo-caption .opening-caption}
<div class="opening-caption-date">FEBRUARY 2025</div>
...
## Control Means Authority over the AI Stack {.visual-stage}
...
::: {.photo-caption}
Tell a capable AI to maximize paperclips and it might consume everything, resisting shutdown along the way. How do we avoid unintended consequences, and is there any objective safe to maximize?
...
## America Tries to Control Chips {.photo-title background-image="../../assets/pe_us_fab.png" background-size="cover" background-position="center"}

::: {.photo-caption}
Export controls keep advanced microchips away from rivals. The CHIPS Act brings chip factories back to the United States.
:::
...
## America's Transactional Alliances {.photo-title background-image="../../assets/pe_gulf_deals.png" background-size="cover" background-position="center"}
...
## China's Digital Silk Road Now Exports AI {.china-models}

:::: {.columns}

::: {.column width="42%"}
<div class="dsr-era">THEN</div>

<div class="dsr-stack">CABLES<br>5G<br>CLOUD</div>

<div class="dsr-explainer">China exported the <strong>infrastructure</strong>.</div>
:::

::: {.column width="13%"}
<div class="dsr-arrow">→</div>
:::

::: {.column width="45%"}
<div class="dsr-era">NOW</div>

<div class="dsr-number">41%</div>

<div class="dsr-explainer"><strong>of open-model downloads</strong> came from Chinese developers in the past year.</div>

<div class="dsr-models">DEEPSEEK · QWEN · Kimi</div>
:::

::::

<div class="dsr-takeaway">China's AI is closing the gap and undercutting on price.</div>


::: {.notes}
The Digital Silk Road originally meant physical and institutional infrastructure: cables, 5G networks, cloud services, smart-city systems, and technical standards. Now it has a second layer. Chinese open-weight models can be downloaded, adapted, and run almost anywhere — often without using a Chinese cloud. Hugging Face reports that models from Chinese developers accounted for 41 percent of open-model downloads over the preceding year, and that China surpassed the United States in both monthly and overall downloads. DeepSeek created the breakthrough moment, but this is an ecosystem story: Qwen alone has produced more than 113,000 derivative models. The qualification matters: downloads are not unique users, and a locally hosted model is not under Beijing's direct operational control. The strategic influence comes from becoming the model family, tooling, and technical default that others build upon.

[Sources]
Hugging Face, "State of Open Source on Hugging Face: Spring 2026," especially "The Geography of Open Source" and "Derivative Models"; Council on Foreign Relations, "China's Digital Silk Road Initiative"; China's Cybersecurity Law, Data Security Law, and Personal Information Protection Law.
:::
...
## Control Tested {.control-tested}

::: {.control-tested-headline}
![](../../assets/anthropic_war.png){fig-alt="Anthropic headline describing its dispute with the Department of War over safeguards for mass domestic surveillance and fully autonomous weapons."}
:::

::: {.control-tested-post}
![](../../assets/pe_hegseth_post.png){fig-alt="Post by the Secretary of War calling Anthropic arrogant and demanding unrestricted access to its models for every lawful purpose."}
:::
...
# So Who Controls AI? {background-color="#041e42"}


## The Dependence Hypothesis {.dependence-trade}

::::: {.dep-diagram}

::: {.dep-side .dep-firms}
<div class="dep-kicker">PRIVATE POWER</div>
<div class="dep-title">FRONTIER AI FIRMS</div>
:::

::: {.dep-flows}
:::: {.dep-flow .dep-flow-right}
::: {.dep-flow-label}
<span class="dep-flow-heading">AI CAPABILITY</span>
:::
<div class="dep-arrow">⟶</div>
::::

:::: {.dep-flow .dep-flow-left}
<div class="dep-arrow">⟵</div>
::: {.dep-flow-label}
<span class="dep-flow-heading">PERMISSION TO SCALE</span>
:::
::::
:::

::: {.dep-side .dep-governments}
<div class="dep-kicker">PUBLIC POWER</div>
<div class="dep-title">NATIONAL GOVERNMENTS</div>
:::

:::::

::: {.dep-takeaway}
Firms hold scarce capabilities. This gives frontier firms control—for now.
:::
...
Name the relationship more carefully: this is a two-way dependence trade, not a story of powerless states. Frontier firms need governments for chips, electricity, public contracts, market access, and legal permission to scale. Governments need frontier firms for models, productivity, cyber capability, and increasingly military and administrative tools. Each side therefore controls something the other values.

The leverage depends on substitution. A frontier firm may be able to replace one national market with customers elsewhere; a government cannot quickly replace a unique frontier capability once its agencies, allies, and domestic firms depend on it. That asymmetry helps explain why hard restrictions are often narrowed or reversed while rules that preserve deployment — transparency, procurement conditions, voluntary frameworks — prove more durable. This is the dependence hypothesis developed in my current research, not a claim that firms always defeat governments.

The line to land is the bottom one: mutual dependence does not mean equal power. Power goes to the side whose contribution is harder to replace. The next section asks whether firms can use that position to regulate themselves credibly.
