...
## AI May Not Do What We Mean {.photo-title background-image="../../assets/day6_alignment_hand.png" background-size="cover" background-position="center"}
...
## A Handful of Firms Hold the Inputs {.visual-stage}
...
## AI Is Now a Weapon {.photo-title background-image="../../assets/pe_battlefield_drone.png" background-size="cover" background-position="center"}
...
::: {.column width="52%"}
- In 2024, the EU asked **Mario Draghi** — former European Central Bank chief — why Europe is falling behind
- His diagnosis: **competitiveness in decline**, weakest at the digital frontier — partly because of Europe's **own rules**
- **Brussels blinked:** the EU is now rewriting its own digital rulebook to win the industry back
...
::: {.figure-takeaway}
Three reversals in eighteen days — and a new normal: **frontier access is now negotiated with Washington.**
:::
