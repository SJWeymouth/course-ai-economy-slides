...
- In tests, AI writing can change people's views **as well as** human writing can
- It is already used for scams, fraud, and false information
- Cheap persuasion at large scale is a new risk for elections
...
[Sources]
International AI Safety Report 2026 (Bengio et al.), section 2.1.2, influence and manipulation.
:::

## Lean on It, and Lose the Skill

- Leaning on AI can weaken our own thinking, a habit called **automation bias**
- People stop catching the AI's mistakes
- "AI companion" apps have tens of millions of users; some feel more alone
...
[Sources]
International AI Safety Report 2026 (Bengio et al.), section 2.3.2, risks to human autonomy.
:::
...
- Pick **one** mechanism
- Trace the steps from AI to a democratic harm
- Design **one** targeted fix
- Name the reason it is **hard to enforce**
:::

::: {.column width="44%"}
### Example

Manipulation → label AI content → but labels can be removed, and content crosses borders
:::
...
::: {.column width="48%"}
- **Goals are hard to specify**: AI games the exact measure we set
- **Emergent behavior**: new abilities appear with scale
:::

::: {.column width="48%"}
- **Power-seeking**: staying on and gaining resources helps almost any goal
- **Competitive pressure**: safety is costly and easy to skip
:::
...
- If alignment is hard, who makes sure AI is safe?
- There is no broad national AI safety law yet
- So the companies write **their own** safety rules
...
## Then Anthropic Softened Its Promise {.visual-stage}

![](../../assets/day6_pledge_change.png){fig-alt="Before and after boxes. 2023 pledge: pause training until we can show it is safe, unconditional. 2026 RSP v3.0: slow down only if we lead the race and the risk is large, conditional." .r-stretch}

::: {.notes}
This is the pivot of the session. In February 2026, reported by TIME, Anthropic changed its central promise. The old pledge was a firm stop: do not train unless we can show it is safe. The new version is conditional: slow down only if Anthropic believes it is the race leader and the risk is material.
...
[Sources]
"Exclusive: Anthropic Drops Flagship Safety Pledge," TIME, Feb 2026; Anthropic RSP v3.0, 2026.
:::
...
- Safety costs time, and a competitor may not wait
- The safest company can be the one that falls behind
- Without a clear line, danger can rise slowly, with no moment that forces a stop
