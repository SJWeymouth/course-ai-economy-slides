...
## The Stanford Reply Narrows the Timing
...
::: {.callout-note}
The debate is about how much of the recent decline can be attributed to AI.
:::
...
## Denmark Shows Work Changing Before Earnings or Hours
...
::: {.metric-label}
largest effect consistent with the earnings and hours data
:::
:::

::::

AI adoption and task reorganization were widespread, but earnings and hours had not changed detectably after two years.

::: {.notes}
Humlum and Vestergaard combine surveys with administrative records in Denmark. Workers report using chatbots and changing tasks, but the researchers find no detectable effects on earnings or hours larger than 2 percent after two years.

This does not mean AI has no economic effect. It suggests that workplace changes can appear before measurable labor-market outcomes.

[Sources]
Anders Humlum and Emilie Vestergaard, “Large Language Models, Small Labor Market Effects,” NBER Working Paper 33777, revised 2026.
:::
...
| **Denmark** | Adoption, tasks, earnings, and hours | Short period and one national setting |
...
- AI exposure is widespread but uneven
...
# Activity: Has AI Reduced Entry-Level Employment? {background-color="#041e42"}

## Audit the Evidence

Your team will decide:

1. What is the strongest evidence for an AI effect?
2. What is the strongest alternative explanation?
3. Where is the weakest link in the evidence?
4. Is the claim **supported**, **plausible but unproven**, or **not supported**?

::: {.callout-note}
Use the activity handout for the full instructions. You have 20 minutes.
:::

::: {.notes}
The full activity prompt is available to students separately. Keep this slide visible only as an introduction.

Suggested timing: 5 minutes to compare the studies, 8 minutes to identify the strongest evidence and alternative explanation, 4 minutes to agree on a verdict, and 3 minutes to prepare a short report.

Ask only two or three teams to present. Invite other teams to state one point of disagreement.

[Sources]
Day 3 activity, “AI and Employment: What the Evidence Can and Cannot Tell Us.”
:::

## Activity Debrief

1. Which evidence changed your view?
2. Which alternative explanation remains credible?
3. What evidence of actual AI use would help most?
