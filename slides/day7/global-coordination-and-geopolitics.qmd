...
## Sovereignty Is a Portfolio, Not Autarky {.sovereignty-modes}
...
3. Shared rules can keep digital markets open by reducing the harms that lead governments to close them.
4. No country is fully independent in AI; strategy means deciding what to build, whom to rely on, and what to regulate.
...
2. AI will affect workers, companies, and places unevenly, so claims about jobs and productivity must be tested with evidence.
3. AI brings real costs—for energy systems, communities, privacy, competition, and democracy.
4. No country controls AI alone, but cooperation is difficult because governments and firms want different things.
