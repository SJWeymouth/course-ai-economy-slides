...
::: {.metric-label}
Why have international AI summits failed to produce global rules?
:::
:::
...
::: {.metric-label}
Why does digital openness require regulation—and what does that imply for sovereignty?
:::
:::
...
## Strategic Digital Sovereignty Has Three Modes {.sovereignty-modes}

<div class="mode-card">
<strong>Mercantilism</strong>
<span>Build domestic capacity</span>
<small>Subsidies · procurement · localization</small>
</div>
<div class="mode-card">
<strong>Alignment</strong>
<span>Join a trusted technology bloc</span>
<small>Chip access · cloud partnerships · security ties</small>
</div>
<div class="mode-card">
<strong>Regulatory power</strong>
<span>Shape access through rules</span>
<small>Safety · competition · data governance</small>
</div>

<div class="mode-bottom">Most states combine the three. Few can achieve full autonomy.</div>
...
## Three Strategies, One Fragmenting Order {.bloc-slide}
...
## Switzerland: Sovereignty Without Autarky {.switzerland-slide}
...
## Three Takeaways {.takeaways-slide}

<div class="takeaway-card"><span>1</span><strong>AI summits failed to produce global rules</strong><small>They generated declarations and voluntary initiatives, but no verification or enforcement.</small></div>
<div class="takeaway-card"><span>2</span><strong>Regulation can sustain openness</strong><small>Privacy, competition, and tax rules contain the conflicts that otherwise produce fragmentation.</small></div>
<div class="takeaway-card"><span>3</span><strong>AI sovereignty is relational</strong><small>States manage dependencies on firms, infrastructure, and technology blocs; few can exit them.</small></div>

::: {.notes}
End by reconnecting the three arguments. The summit process shows that recognizing a cross-border problem is easier than agreeing on rules that constrain states or firms. Coordinated regulation can make cross-border digital integration politically sustainable. But AI infrastructure is controlled through concentrated private and geopolitical networks, so sovereignty means managing dependencies rather than achieving isolation.

[Sources]
Bletchley Declaration, 2023; New Delhi Declaration, 2026; Future of AI Summit Series, 2026; Stephen Weymouth, *Digital Globalization*, chapters 1 and 5; Stephen Weymouth, “Digital Disintegration,” 2025.
:::
