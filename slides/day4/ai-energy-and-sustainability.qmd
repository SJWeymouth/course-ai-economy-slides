...
<div class="session-calculator" id="session-calculator">
  <div class="calculator-controls">
    ...
    <label for="session-grid">Grid carbon intensity <output id="session-grid-value">394 g CO₂/kWh</output></label>
    <input id="session-grid" type="range" min="25" max="900" step="1" value="394">
  ...
  <div class="calculator-result" aria-live="polite">
    ...
    <div class="calculator-comparison">
      About <strong id="session-home-equivalent">3.5 million</strong> sessions emit as much CO₂ as one year of electricity for an average U.S. home <strong>(≈ <span id="session-home-carbon">4.1</span> t)</strong>.
    </div>
  </div>
</div>
...
(() => {
  ...
  const update = () => {
    ...
    const equivalentSessions = 10500 / sessionKWh;
    const homeCarbonTonnes = 10500 * gridIntensity / 1000000;
    ...
    document.getElementById('session-home-carbon').textContent = homeCarbonTonnes.toFixed(1);
...
0.003 kWh × 394 g CO₂/kWh = about 1.2 g CO₂.

The household comparison uses 10,500 kWh per year. At 394 g CO₂/kWh, that electricity emits about 4.1 metric tonnes of CO₂. At ten messages per session, 10,500 kWh divided by 0.003 kWh is about 3.5 million sessions. This compares electricity-related emissions only; household heating, transport, food, and other emissions are excluded.
...
[Sources]
OpenAI Academy, "Environmental Impact of AI," updated June 2026; Epoch AI, "How Much Energy Does ChatGPT Use?" February 2025; U.S. Energy Information Administration, "Electricity Use in Homes," 2023; U.S. EPA, Greenhouse Gas Equivalencies Calculator: Calculations and References, 2024; IEA, Key Questions on Energy and AI, Executive Summary, 2026.
:::
