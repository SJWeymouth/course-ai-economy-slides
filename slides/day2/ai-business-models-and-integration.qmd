...
![](../../assets/business-operating.png){fig-alt="Business and operating model framework" .r-stretch}
...
![](../../assets/amazon_sequoia_fulfillment.jpg){fig-alt="Amazon Sequoia robots in a fulfillment center" .r-stretch}
...
![](../../assets/AI_virtuous.png){fig-alt="AI virtuous cycle" .r-stretch}
...
![](../../assets/saas_growth_collapse.png){fig-alt="Public SaaS median revenue growth from 2021 to 2025" .r-stretch .figure-large}
...
![](../../assets/b2b_bifurcation_higher.png){fig-alt="2025 stock gains among selected B2B software firms" width="100%"}
:::

::: {.column width="50%"}
### Firms whose shares fell

![](../../assets/b2b_bifurcation_lower.png){fig-alt="2025 stock losses among selected B2B software firms" width="100%"}
:::
...
![](../../assets/ai_agent_tools_report_2026.png){fig-alt="AI agent connected to memory, web, and computer tools" .r-stretch}
...
![](../../assets/ai_agent_task_length_report_2026.png){fig-alt="AI agent task length over time" .r-stretch}
...
![](../../assets/mollick_figure_2.png){fig-alt="Shopify and Duolingo AI workplace announcements" .r-stretch}
...
![](../../assets/mckinsey_exhibit_1.png){fig-alt="AI adoption and scaling by organizations" .r-stretch}
...
![](../../assets/mckinsey_exhibit_2.png){fig-alt="AI agent use across business functions" .r-stretch}
...
![](../../assets/mckinsey_exhibit_6.png){fig-alt="Reported organization-wide benefits from AI" .r-stretch}
...
![](../../assets/mckinsey_exhibit_11.png){fig-alt="Workflow redesign among AI high performers" .r-stretch}
...
![](../../assets/mollick_figure_1.png){fig-alt="Leadership, the lab, and the crowd" .r-stretch}
