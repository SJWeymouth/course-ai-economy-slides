...
3. Which advantage becomes more important? Which become less important?
4. Does the existing company become weaker, remain necessary, or become stronger? Why?
...
## A Faster Task May Not Improve the Full Process
...
An employee prepares a sales proposal in 20 minutes instead of two hours.
:::

::: {.column width="50%"}
### The company may not improve

Pricing, legal review, approval, and customer follow-up still take ten days.
:::
...
::: {.notes}
Distinguish a task from a complete process. AI may help an employee draft a proposal faster, but the proposal still moves through pricing, legal review, approval, and customer follow-up. If those steps do not change, the total time needed to make a sale may remain the same.
...
Measure the task in minutes saved. Measure the complete process using total time, number of cases completed, sales success, cost, or quality. Time saved is useful evidence, but it is not the final company result.
...
- **AI agents can complete multiple steps and use other software,** which may change how business software is used and priced (changing the business and operating models of software firms)
- **Company results usually improve only when the full work process changes,** and for non-AI native firms, this AI tranition can take a long time
