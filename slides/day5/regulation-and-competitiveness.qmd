...
- **Banned:** social scoring
- **High risk:** screening job applicants or deciding who receives a loan
- **Transparency rules:** chatbots and deepfakes
- **Minimal risk:** spam filters and video-game AI
:::

::: {.column width="53%"}
![](../../assets/day5_ai_act_tiers.png){fig-alt="Pyramid of the EU AI Act's four risk levels: unacceptable risk, exemplified by social scoring, is banned; high-risk uses such as employment and credit decisions carry strict duties; chatbots and deepfakes face transparency rules; and minimal-risk uses such as spam filters and video-game AI have no extra rules" height="590"}
:::

::::

::: {.notes}
This combines the institutional philosophy and the risk structure. Europe acts before harm occurs, with a binding framework coordinated through the EU AI Office. A few uses are banned outright, including social scoring and untargeted face scraping. High-risk uses include systems that screen job applicants or assess whether a person qualifies for a loan; these carry risk-management, human-oversight, documentation, and registration duties. Chatbots and deepfakes face transparency requirements. Spam filters and AI used in video games illustrate the minimal-risk category, which receives no additional duties under the AI Act.

Most of the rules fall on the narrow top of the pyramid, not on ordinary software.

[Sources]
European Commission, "AI Act: A Risk-based Approach," updated July 2026; Regulation (EU) 2024/1689, Articles 5, 6, and 50 and Annex III.
:::
...
- **Sandboxes:** time-limited, regulator-supervised environments where firms can develop and test AI—including in real-world settings—before launch.
