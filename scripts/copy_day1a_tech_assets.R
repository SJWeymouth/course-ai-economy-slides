# copy_day1a_tech_assets.R
# Copy only the image files referenced by the Day 1A Quarto deck
# from a large Dropbox image library into this repository's assets/ folder.

# ---- Settings you may change ----
deck_path <- file.path("slides", "day1", "history-technological-shocks.qmd")
assets_dir <- "assets"
...
fallback_assets <- c(
  "AI_graphic.png",
  "ICT.jpg",
  "Trump_protectionism1.png",
  "chinese_exports.png",
  "cover.png",
  "deindustrialization.png",
  "dreamliner.png",
  "emp_shares.jpg",
  "first_unbundle.jpg",
  "g7.jpg",
  ...
  "share_shift.jpg",
  "steamboat.png",
  "tradebalance_goods_services.svg",
  "train2.jpg",
  "trump_romney.png"
)
...
report_path <- "asset_copy_report_day1a.csv"
...
if (duplicates_n > 0) {
  ...
  cat("there was a unique exact-case match. Review asset_copy_report_day1a.csv if needed.\n")
}

cat("\nNext steps:\n")
cat("1. Render slides/day1/history-technological-shocks.qmd in RStudio.\n")
